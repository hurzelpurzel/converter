...
import (
	...
	"pottmeier.de/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "676864a3.pottmeier.de",
	...
	if err := (&controller.TLSSecretWatcherReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "TLSSecretWatcher")
		os.Exit(1)
	}
